...
const TeamMember = ({ member }) => (
  <div className="flex items-center gap-3">
    ...
    },
    {
      ...
      icon: MessageSquare,
      description:
        "Ideal for blog comments, discussion threads, and forum posts",
      names: [
        "alex.thompson",
        "maria_garcia",
        "john.doe.2024",
...
const ChatMessage = ({ message }) => (
  <div className="message">
    ...
    },
    {
      ...
      icon: Wallet,
      description:
        "Perfect for crypto wallets, blockchain explorers, and transaction displays",
      names: [
      ...
      <section className="container mx-auto px-4 py-12 border-b">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground">
            Real UI component blocks showcasing Sigma Avatars in practical
            applications
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm mt-1">
                        Working on some exciting new designs. Can't wait to
                        share them!
                      </p>
                      <div className="flex items-center gap-4 mt-2">
                        <Button
                        ...
                        <Button
                          ...
                          className="h-8 px-2 text-muted-foreground"
                        >
                          <MessageSquare className="h-4 w-4 mr-1" />2
                        </Button>
                        <Button
                          variant="ghost"
                          size="sm"
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Team chat with online status</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm">
                      <strong>Jennifer Liu</strong> liked your post
                    </p>
                    <p className="text-xs text-muted-foreground">
                      2 minutes ago
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm">
                      <strong>Carlos Rodriguez</strong> commented on your design
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm">
                      <strong>Project Alpha</strong> milestone completed
                    </p>
      ...
      <section className="container mx-auto px-4 py-12 border-t">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl">
            Sigma Avatars supports all modern CSS color formats: hex colors (3,
            6, or 8 digits), RGB/RGBA, HSL/HSLA, OKLCH, and CSS custom
            properties for seamless design system integration.
          </p>

          <div className="grid gap-6 md:grid-cols-2">
            {Object.entries(namedPalettes).map(
              ([name, colors], paletteIndex) => (
                <Card key={name}>
                  <CardHeader>
                    ...
                    <div className="flex gap-6">
                      ...
                      <div className="flex flex-col gap-2 justify-center">
                        ...
                        <Avatar
                          name={`${name} User 2`}
                          variant={
                            ["bauhaus", "fractal", "mage", "barcode", "pepe"][
                              paletteIndex % 5
                            ] as any
                          }
                          colors={colors}
